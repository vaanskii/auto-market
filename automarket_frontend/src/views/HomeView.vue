    ...
    <div class="flex flex-col justify-between bg-no-repeat bg-fixed bg-cover bg-right md:bg-center">
      ...
      <div>
        <div class="flex items-center justify-center w-full">
          <h1 class="typed-text absolute 2xl:top-38 font-[700] w-[90%] top-32 text-center uppercase text-3xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-5xl">
            <span v-for="(word, index) in words" :key="index" :class="'word-' + index">{{ $t(`main-header.words.${word}`) }}</span>
          </h1>
          <h1 class="typed-text absolute 2xl:top-[17rem] xl:top-[17rem] lg:top-[17rem] md:top-[17rem] font-[600] w-[90%] text-center uppercase text-xl sm:text-xl md:text-2xl lg:text-2xl xl:text-4xl">

<template>
    <div class="mt-32 md:mb-0 mb-12 bg-black pt-9">
  <div class="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
      ...
      <div class="md:w-[316px]">
        ...
        <h1 class="text-white font-extrabold">
          <span class="text-rose-600">
            <img src="/car.png" class="w-12 h-12" alt="logo">
          </span>
        </h1>
        </p>
        ...
        <div class="mt-[18px] flex gap-4">
          <a class="hover:scale-110" target="_blank"
            ...
            href="/"><img alt="linkdin icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="/socials/linkedin.png" /></a><a
            class="hover:scale-110" target="_blank"
            href="/"><img alt="instagram icon" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="/socials/instagram.png" /></a><a
            class="hover:scale-110" target="_blank"
            href=""><img alt="twitter icon" loading="lazy" class="bg-white rounded-lg p-1" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="/socials/twitter.png" /></a><a
            class="hover:scale-110" target="_blank"
            href="https://www.youtube.com/"><img alt="youtube icon" class="bg-white rounded-lg p-1" loading="lazy" width="36" height="36" decoding="async" data-nimg="1" style="color:transparent" src="/socials/video.png" /></a>
        </div>
      </div>
      <div class="md:w-[316px]">
        <div class="mt-[23px] flex">
          ...
          <div class="ml-[18px]">
            <!-- tel:+911800123444 -->
            <a href="#" class="font-Inter text-[14px] font-medium text-white">+995 123456</a>
        ...
        <div class="mt-[23px] flex">
          ...
          <div class="ml-[18px]">
            <a href="#" class="font-Inter text-[14px] font-medium text-[#fff]">help@lorem.com</a>
    ...
    <div class="flex items-center justify-center pb-8 pt-[9px] md:py-8">
      <p class="text-[10px] font-normal text-white md:text-[12px]">
        © Copyright
        <!-- -->2024
        <!-- -->, All Rights Reserved by VAANSKII. PVT. LTD
      </p>
    </div>
  </div>
</div>
